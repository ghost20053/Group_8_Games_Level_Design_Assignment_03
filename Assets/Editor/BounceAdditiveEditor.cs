...
[CustomEditor(typeof(BounceAdditive))]
public class BounceAdditiveEditor : Editor 
{
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.HelpBox("Bounce Additive Force values typically have a low or no x (horizontal) force, with a low y (vertical) force. Experiment with varying values for different behaviours.", MessageType.Info);
	}
}
