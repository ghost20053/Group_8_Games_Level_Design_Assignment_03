...
[CustomEditor(typeof(TriggerExit))]
public class TriggerExitEditor : Editor 
{
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.HelpBox("One or more messages can be set to be sent on collision exit with the trigger.", MessageType.Info);
	}
}
